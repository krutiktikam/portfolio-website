      ...
      <div className="portfolio-column">
        ...
        <div className="behance-card" id="profile-card">
          <div className="hero-header">
            <span className="logo">krutik.dev</span>
        ...
        <div className="behance-card" id="about-card">
          ...
          <div className="about-portrait-container">
            <img src={portraitImg} alt="Krutik portrait" className="about-portrait" />
          </div>
          ...
          <form onSubmit={handleContactSubmit} className="contacts-grid">
            ...
            <div className="contact-form-group">
              ...
              <input 
                ...
                required 
                placeholder="nikitakhvatov@gmail.com" 
                className="contact-form-input" 
              />
            </div>
